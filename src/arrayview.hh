...
protected:
   ...
   */
  Matrix(SmartPtr< ArrayBase<T> > data, size_t rows, size_t cols, size_t ld, size_t offset)
    : _data(data), _rows(rows), _cols(cols), _leading_dimension(ld), _offset(offset)
  {
    // Pass...
  }
...
#endif // __FLUC_LINALG_ARRAYVIEW_HH__
